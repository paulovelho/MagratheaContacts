...
## -- date of creation: [2024-01-07 22:21:27]
...
class EmailBase extends MagratheaModel implements iMagratheaModel {
	...
	public $id, $source_id, $origin_key, $mail_type, $email_from, $email_replyTo, $email_to, $msg_subject, $message, $priority, $add_date, $sent_date, $sent_status;
	...
	public function GetControl() {
		return new \MagratheaContacts\Email\Base\EmailControlBase();
	}
